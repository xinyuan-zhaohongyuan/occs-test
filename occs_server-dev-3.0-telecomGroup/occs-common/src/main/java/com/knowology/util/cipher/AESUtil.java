package com.knowology.util.cipher;
...
public class AESUtil {
    ...
    public static String KEY = "csldfw126394%$@#";

    public static String IV = "234382jkdnkd^&#@";
    ...
    public static void main(String[] args) {
        try {
            System.out.println(AESUtil.encrypt("xullent"));
            System.out.println(AESUtil.desEncrypt("oIOejOYTKNlATXKd1TP0JA=="));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
