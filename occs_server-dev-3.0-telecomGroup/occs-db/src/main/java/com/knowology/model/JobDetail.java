...
@Table(name = "Z_JOB_DETAILS")
public class JobDetail extends BaseRowModel {
    @Id
    @Column(name = "ID")
     ...
     */
    @Column(name = "OVERALL")
    @ExcelProperty(value = "整体满意度", index = 2)
    ...
    @ExcelProperty(value = "满意原因", index = 3)
    ...
    @ExcelProperty(value = "满意原因(内容)", index = 4)
    ...
    @ExcelProperty(value = "不满意原因", index = 5)
    ...
    @ExcelProperty(value = "不满意原因(内容)", index = 6)
    ...
    @ExcelProperty(value = "等候时长不满意", index = 7)
    ...
    @ExcelProperty(value = "等候时长不满意(内容)", index = 8)
    ...
    @ExcelProperty(value = "服务态度不满意", index = 9)
    ...
    @ExcelProperty(value = "服务态度不满意(内容)", index = 10)
    ...
    @ExcelProperty(value = "业务技能不满意", index = 11)
    ...
    @ExcelProperty(value = "业务技能不满意(内容)", index = 12)
    ...
    @ExcelProperty(value = "服务环境不满意", index = 13)
    ...
    @ExcelProperty(value = "服务环境不满意(内容)", index = 14)
